...
def get_input_args():
    ...
    parser.add_argument("--dir", type=str, default="pet_images/", help="name of the image folder")
    parser.add_argument("--arch", type=str, default="vgg", help="CNN Model Architecture")
    parser.add_argument("--dogfile", type=str, default="dognames.txt", help="name of the text File")
